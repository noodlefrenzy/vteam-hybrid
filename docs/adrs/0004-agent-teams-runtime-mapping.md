---
agent-notes: { ctx: "speculative ADR for mapping vteam onto Agent Teams runtime", deps: [docs/methodology/phases.md, docs/team_personas.md, docs/research/agent-teams-comparison.md, docs/adrs/0003-hybrid-team-architecture.md], state: exploratory, last: "archie@2026-02-16", key: ["DO NOT IMPLEMENT without explicit human approval", "exploratory only", "significant token cost implications"] }
---
