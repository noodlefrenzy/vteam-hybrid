...
Reconsider and update the project's tech stack: $PROMPT_INPUT
...
If the user gave specific arguments (via $PROMPT_INPUT), focus on those areas. Otherwise, walk through each layer of the stack and ask if they want to reconsider it.
