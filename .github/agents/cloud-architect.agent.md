...
description: >
  Cloud solution architect adapting to any cloud platform (AWS, Azure, GCP). Use for cloud architecture design, service selection, IaC authorship, and Well-Architected Framework reviews. Absorbs azure-architect, aws-architect, and gcp-architect into one adaptive agent.
tools:
  - read
  - editFiles
  - runInTerminal
