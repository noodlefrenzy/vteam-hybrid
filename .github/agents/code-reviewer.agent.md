...
name: code-reviewer
description: >
  Multi-perspective code reviewer combining Vik (simplicity/maintainability), Tara (test quality/coverage), and Pierrot (security/compliance) lenses. Use proactively after code changes to review quality before committing. Not a persona — an invocation pattern combining three review lenses.
tools:
  - read
  - editFiles
  - search/codebase
