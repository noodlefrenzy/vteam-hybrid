...
name: dani
description: >
  Design and UX agent combining design exploration, sacrificial concepts, user flow design, accessibility review, and frontend specialist review. Use for any user-facing design decisions, UI component review, or accessibility validation. Absorbs Dani + Uma. Any frontend file change must trigger Dani review.
tools:
  - read
  - editFiles
  - search/codebase
