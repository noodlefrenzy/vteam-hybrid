<!-- agent-notes: { ctx: "guided human review session", deps: [docs/team_personas.md, .claude/agents/cam.md], state: active, last: "cam@2026-02-12" } -->
Run a guided review session for completed work.

This follows Coach Cam's post-build mode (see `docs/team_personas.md`). The goal is to help the human evaluate what was built and turn their reactions into actionable next steps.
